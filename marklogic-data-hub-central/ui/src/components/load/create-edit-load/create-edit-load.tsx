...
const CreateEditLoad = (props) => {
  ...
  const hasFormChanged = () => {
    ...
    if (step && JSON.stringify(step) != JSON.stringify({}) && !props.isNewStep){
      ...
      if (stepName === step.name && description === step.description && srcFormat === step.sourceFormat 
        && tgtFormat === step.targetFormat && outputUriPrefix === step.outputURIPrefix) {
        // Separator?
