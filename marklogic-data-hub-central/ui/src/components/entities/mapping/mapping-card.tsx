                ...
                {props.canReadWrite ? <Col >
                    ...
                    <Col key={index}>
                        ...
                        >
                            <Card
                                actions={[
                                    <MLTooltip title={'Edit'} placement="bottom"><Icon className={styles.editIcon} type="edit" key ="last" role="edit-mapping button" data-testid={elem.name+'-edit'} onClick={() => OpenStepSettings(index)}/></MLTooltip>,
